...
// Using imported products from centralized data
const allProducts = [
  {
    id: 1,
  ...
  },
  {
    ...
    category: "Journals & Planners",
    price: 29,
    image: "/placeholder.svg?key=ipx34",
    rating: 4.8,
    reviews: 86,
    comingSoon: true,
  ...
  },
  {
    ...
    price: 15,
    image: "/placeholder.svg?key=68bxz",
    rating: 4.9,
    reviews: 68,
    comingSoon: true,
  ...
  },
  {
    ...
    category: "Journals & Planners",
    price: 35,
    image: "/placeholder.svg?key=i6l9o",
    rating: 4.9,
    reviews: 47,
    comingSoon: true,
    description:
  ...
  },
  {
    ...
    category: "Journals & Planners",
    price: 25,
    image: "/placeholder.svg?key=be7dx",
    rating: 4.8,
    reviews: 39,
    comingSoon: true,
