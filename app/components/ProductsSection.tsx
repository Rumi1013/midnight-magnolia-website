...
export default function ProductsSection() {
	...
	return (
		<section
			ref={ref}
			id="products"
			className="py-20 bg-midnight-blue">
			<div className="container mx-auto px-6">
				<motion.div
					...
					<p className="font-lora text-xl text-magnolia-white/80 max-w-3xl mx-auto leading-relaxed">
						Carefully crafted tools to support your healing journey. Each
						product is designed with love, intention, and deep respect for your
						unique path.
					</p>
				</motion.div>
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
					{featuredProducts.map((product, index) => (
						<motion.div
							...
							className="bg-magnolia-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 group h-full flex flex-col relative overflow-hidden border-2 border-transparent hover:border-gold/30"
							style={{ boxShadow: "0 10px 40px rgba(163, 177, 138, 0.15)" }}>
							{/* Coming Soon Banner */}
							{product.comingSoon && (
								<div className="absolute -top-2 -right-2 bg-gradient-to-r from-gold via-sage-green to-gold text-midnight-blue font-montserrat font-bold text-xs px-6 py-2 transform rotate-12 shadow-lg z-10 animate-pulse">
									COMING SOON
								</div>
							)}
							...
							<div className="text-center mb-6">
								...
								<div className="bg-midnight-blue text-magnolia-white font-montserrat text-xs font-bold tracking-wide uppercase px-4 py-1.5 rounded-full inline-block mb-3 group-hover:bg-gold group-hover:text-midnight-blue transition-colors duration-300">
									{product.category}
								</div>
								<h3 className="font-playfair text-2xl font-bold text-midnight-blue mb-2 group-hover:text-gold transition-colors duration-300">
									{product.title}
								</h3>
								<p className="font-montserrat text-sage-green font-semibold text-sm tracking-wide uppercase">
									{product.subtitle}
								</p>
							</div>

							<p className="font-lora text-gray-800 leading-relaxed mb-6 flex-grow">
								{product.description}
							</p>

							<div className="mb-6">
								<h4 className="font-montserrat text-sm font-semibold text-midnight-blue mb-3">
									Available Formats:
								</h4>
							...
							<ul className="space-y-2 mb-8">
								{product.features.map((feature, idx) => (
									<li
										key={idx}
										className="flex items-center gap-3 font-lora text-gray-700 text-sm">
							...
							<div className="space-y-4 mt-auto">
								<div className="flex items-center justify-between">
									<div>
										...
										<div className="text-gray-600 font-lora text-sm">
											Digital
										</div>
									</div>
									<div>
										<div className="text-midnight-blue font-playfair text-2xl font-bold">
											{product.price}
										</div>
