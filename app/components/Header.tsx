      ...
      {isMenuOpen && (
        ...
        >
          <div className="px-6 py-4 space-y-4">
            ...
            <Link
              href="/blog"
              className="w-full bg-sage-green hover:bg-sage-green/90 text-midnight-blue font-montserrat font-semibold px-6 py-3 rounded-full transition-all duration-300 mt-4 block text-center"
            >
              Enter Garden
            </Link>
          </div>
