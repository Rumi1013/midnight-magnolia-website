				...
				<div className="grid lg:grid-cols-2 gap-16 items-center w-full max-w-7xl mx-auto">
					...
					<motion.div
						...
						<motion.p
							...
							automation, and healing coexist — helping you earn with ease,
							create with freedom, and live with intention.
						</motion.p>
						...
						<div className="relative w-[400px] h-[400px] lg:w-[500px] lg:h-[500px] flex items-center justify-center">
							...
							<motion.div
								...
								<div
									...
									style={{
										boxShadow:
											"0 0 60px rgba(163, 177, 138, 0.2), inset 0 0 40px rgba(0,0,0,0.3)",
									}}
								/>
