					...
					<motion.div
						...
						<div className="space-y-6">
							...
							<motion.p
								...
								Where ancestral wisdom meets Southern Gothic grace. Begin your
								journey of healing through gentle productivity, sacred rituals,
								and transformative digital tools.
							</motion.p>
						</div>
						...
						<motion.div
							...
							<button
								className="bg-sage-green hover:bg-sage-green/90 text-midnight-blue font-montserrat font-semibold px-10 py-5 rounded-full transition-all duration-300 hover:scale-105 min-h-[56px] text-lg"
								style={{
									boxShadow:
										"0 0 30px rgba(163, 177, 138, 0.3), 0 10px 40px rgba(163, 177, 138, 0.2)",
								}}>
								Enter the Garden
							</button>
							<button className="border-2 border-gold/50 hover:border-gold text-magnolia-white hover:text-gold font-montserrat font-semibold px-10 py-5 rounded-full transition-all duration-300 min-h-[56px] text-lg hover:bg-gold/10">
						...
						<motion.div
							...
							<div className="text-center">
								<p className="text-gold font-playfair text-3xl font-bold">
									500+
								</p>
								<p className="text-magnolia-white/60 font-montserrat text-sm">
									Healing souls
								</p>
							</div>
