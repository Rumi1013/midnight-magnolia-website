    ...
    <footer className="footer">
      <div className="footer-inner">
        ...
        <nav className="footer-nav" aria-label="Footer navigation">
          <a href="/shop">Shop</a>
          <a href="/tiers">Services</a>
          <a href="/blog">Journal</a>
          <a href="mailto:latisha@midnight-magnolia.com">Contact</a>
        </nav>
        <div id="accessibility" className="sr-only">
          Accessibility Promise: WCAG AA+ contrast, motion under 3% luminance shift, skip links, and transcripts for every
          audio ritual.
        </div>
        ...
        <div className="footer-legal">
          <span>© {currentYear} Midnight Magnolia</span>
